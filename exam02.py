...
# 3. a[[1]] = 'python'
# 4. a[250] = 'python'
# 3번, 리스트는 key가 될 수 없다. 왜냐하면 값이 바뀔 수 있기 때문이다.(mutable) immutable
...
# Q12. 파이썬은 다음처럼 동일한 값에 여러 개의 변수를 선언할 수 있다. 다음과 같이 a,b 변수를 선언한 후 a의 두 번째 요솟값을 변경하면 b값은 어떻게 될까?
